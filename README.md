...
| `index_damage_prevention`                  | [@PieMonsterEater](https://github.com/PieMonsterEater)         | Prevents joystick damage on index controllers. Left touchpad is crouch, right touchpad is sprint. Otherwise same as index profile.                                                                                                 |
